const DraftsPage = {
  async init() {
    ...
    try {
      const emails = await MailService.getDrafts();
      EmailList.render(list, emails, { emptyTitle: 'No drafts', emptyText: 'Saved drafts will appear here.' });
    } catch (err) {
...
document.addEventListener('DOMContentLoaded', () => DraftsPage.init());
